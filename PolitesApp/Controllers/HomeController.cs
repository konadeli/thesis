            ...
            if (model.MyDocument != null)
            {
                ...
                if (model.MyDocument.Length > 0)
                {
                    ...
                    using (var ms = new MemoryStream())
                    {
                        ...
                        // Create a message object containing the document to share (as a blob), and the public key
                        ...
                        // use it to ENCRYPT the whole message object. Now the entire message including the document and the signature can ONLY be decrypted  by the AADE recipient, because only they have the private key
